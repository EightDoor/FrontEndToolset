<template>
  ...
  <el-table :data="tableData" style="width: 100%">
    ...
    <el-table-column label="操作">
      <template #default="scope">
        <el-button type="primary" @click="action(scope.row)">播放</el-button>
      </template>
    </el-table-column>
  </el-table>
  <el-pagination
...
import { Artist, SearchList } from '@/types/music/search_music_type';
import { SongPalyList } from '@/types/music/detail';
